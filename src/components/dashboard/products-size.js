    ...
    <FormItem>
      ...
      <Select onValueChange={onValueChange} defaultValue={defaultValue}>
        ...
        <SelectItem value="wjeans">Jeans</SelectItem>
          ...
          <SelectItem value="wbelts">Belt</SelectItem>
        </SelectContent>
      </Select>
      <FormMessage />
    </FormItem>
  ...
  return (
    <FormItem>
      ...
      <Select onValueChange={onValueChange} defaultValue={defaultValue}>
        ...
        <SelectContent>
          <SelectItem value="mwork">Work & Safty Shoes</SelectItem>
          <SelectItem value="mloafers">Loafers & Slip-Ons</SelectItem>
  ...
  return (
    <FormItem>
      ...
      <Select onValueChange={onValueChange} defaultValue={defaultValue}>
        ...
        <SelectContent>
          <SelectItem value="wloafers">Loafers & Slip-Ons</SelectItem>
          ...
          <SelectItem value="wothers">Others</SelectItem>
        </SelectContent>
      </Select>
      <FormMessage />
    </FormItem>
